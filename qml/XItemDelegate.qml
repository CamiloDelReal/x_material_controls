...
ItemDelegate {
    ...
    property alias secondaryItem: secondaryItemCtrl.children
    ...
    contentItem: RowLayout {
        ...
        ColumnLayout {
            ...
            XSubheadingLabel {
                ...
                rightPadding: delegateCtrl.indicator.visible
                              ? delegateCtrl.indicator.childrenRect.width + delegateCtrl.rightPadding + delegateCtrl.spacing
                              : 0
    ...
    indicator: Item {
        id: secondaryItemCtrl
        x: delegateCtrl.width - childrenRect.width - delegateCtrl.rightPadding
        y: (delegateCtrl.topPadding + delegateCtrl.bottomPadding + (delegateCtrl.availableHeight - childrenRect.height)) / 2
